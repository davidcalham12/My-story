...
| 13 | The 100,000-token ceiling and the orchestrator | halt the orchestrator at 100,000 · one orchestrator per stage and chapter · measure, warn and show | a halt at 100,000 stops every novel (measured median 147,000); a per-stage orchestrator is a two-day redesign days before delivery | **measure, warn and show** now; the per-stage orchestrator is the declared next step |
