...
| 2026-09-24 | v3 | `output/the-other-side-of-the-hill/dist/v3/novel.html` | **pass** | the reader change (fact 36 → "the wooden treehouse observatory"). 4 what changed: the first page, linking chapters 3 and 10. 1 cover with dedication. 2 index, no broken link. 5 no leftovers. Recorded in `validations` |
